...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-24 18:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0e8f4424-102a-49b5-a0b6-93ad6d43f548.git
$ cd 0e8f4424-102a-49b5-a0b6-93ad6d43f548
```
